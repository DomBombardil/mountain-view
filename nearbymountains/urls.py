...
from .views import mountain_search, mountain_map, nearby_mountains_api, geocode_location_api, mountain_route_api, nearby_parking_api, trail_access_points_api, mountain_weather_api, route_pois_api
...
urlpatterns = [
    ...
    path("api/route-pois/", route_pois_api, name="route_pois_api"),
